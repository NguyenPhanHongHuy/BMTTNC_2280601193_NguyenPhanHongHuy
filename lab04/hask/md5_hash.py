...
def md5(message):
    ...
    for i in range(0, len(message), 64):
        ...
        for j in range(64):
            ...
            d = c
            c = b
            b = b + left_rotate((a + f + 0x5A827999 + words[g]) & 0xFFFFFFFF, 3) # Lưu ý: Hằng số 0x5A827999 là một ví dụ, các hằng số T (lược đồ bảng) trong MD5 sẽ thay đổi theo từng bước j.
            a = temp
